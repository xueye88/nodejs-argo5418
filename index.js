...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '5418';          // 鍥哄畾闅ч亾鍩熷悕,鐣欑┖鍗冲惎鐢ㄤ复鏃堕毀閬�
const ARGO_AUTH = process.env.ARGO_AUTH || '5418';              // 鍥哄畾闅ч亾瀵嗛挜json鎴杢oken,鐣欑┖鍗冲惎鐢ㄤ复鏃堕毀閬�,json鑾峰彇鍦板潃锛歨ttps://json.zone.id
